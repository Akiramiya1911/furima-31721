...
ActiveRecord::Schema.define(version: 2020_11_27_050649) do
  ...
  create_table "buyer_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["item_purchase_id"], name: "index_buyer_addresses_on_item_purchase_id"
  end
  ...
  add_foreign_key "buyer_addresses", "item_purchases"
